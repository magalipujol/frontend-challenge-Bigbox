...
app.component('activity-card', {
    ...
    <div class="card-body activity-card-body">
      <h5 class="card-title activity-title">{{ this.activities[index]?.title }}</h5>
...
app.component('cards-grid', {
    ...
    <div class="container">
            <div class="row">
                <div class="col-sm">
                    <activity-card :activities="activities" :index="0"></activity-card>
                </div>
                <div class="col-sm">
                    <activity-card :activities="activities" :index="1"></activity-card>
                </div>
                <div class="col-sm">
